...
# Include font files
include vendor/horizon/fonts/fonts.mk
...
# FRP
PRODUCT_COPY_FILES += \
    vendor/horizon/prebuilt/common/bin/wipe-frp.sh:$(TARGET_COPY_OUT_RECOVERY)/root/system/bin/wipe-frp
...
PRODUCT_COPY_FILES += \
    vendor/horizon/prebuilt/common/etc/init/init.openssh.rc:$(TARGET_COPY_OUT_PRODUCT)/etc/init/init.openssh.rc
...
PRODUCT_COPY_FILES += \
    vendor/horizon/config/permissions/privapp-permissions-custom.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-custom.xml
